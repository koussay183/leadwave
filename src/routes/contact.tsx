    ...
    <Layout>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 grid lg:grid-cols-2 gap-12 items-center relative">
          <div className="animate-fade-up">
            ...
            <h1 className="mt-5 text-4xl sm:text-5xl font-extrabold leading-tight">
              Comment pouvons-nous <span className="text-[var(--brand-blue)]">vous aider</span> ?
            </h1>
            <p className="mt-5 text-lg text-muted-foreground max-w-xl">
              Vous avez une question en tête ? Nous sommes là pour vous aider — collaboration ou renseignements
              sur nos services, nous sommes à votre disposition.
            </p>
            <div className="mt-8 grid sm:grid-cols-3 gap-4">
              {[
                { i: Mail, t: "Email", v: "info@leadwave.tn", c: "var(--brand-blue)" },
                { i: Phone, t: "Téléphone", v: "+216 28 776 710", c: "var(--brand-red)" },
                { i: MapPin, t: "Adresse", v: "Megrine Sidi Rezig", c: "var(--brand-yellow)" },
              ].map((x) => (
      ...
      <section className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-20 grid lg:grid-cols-5 gap-10">
        <div className="lg:col-span-2 space-y-6">
          <div>
            <span className="chip">Plus de contacts</span>
            <h2 className="mt-3 text-3xl font-bold">Nous serons heureux de répondre à votre question.</h2>
          </div>
          <div className="space-y-4">
            {[
              { i: MapPin, t: "Localisation", v: "Avenue Farhat Hached, Immeuble Chebil bloc B appartement B1.2, Megrine Sidi Rezig, 2033, Tunisia", c: "var(--brand-red)" },
              { i: Phone, t: "Appelez-nous", v: "+216 28 776 710", c: "var(--brand-blue)" },
              { i: Mail, t: "Envoyez-nous un email", v: "info@leadwave.tn", c: "var(--brand-yellow)" },
            ].map((x) => (
        ...
        >
          ...
          <div>
            <label className="text-sm font-semibold">Votre demande</label>
          ...
          {sent && <p className="text-sm text-[var(--brand-blue)] font-semibold">Merci ! Nous vous recontactons rapidement.</p>}
        </form>
      </section>
    </Layout>
  );
